<template>
  <div class="UserAssets-bgcolor">
    <div class="UserAssets-left">
      ...
      <el-col :span="12">
        <el-menu default-active="2"  class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
          background-color="#1e69fe" text-color="#fff" active-text-color="#1e69fe" unique-opened v-model="option">
          <el-submenu index="1">
            <template slot="title">
              <div class="menu-op">
                <div>
      ...
      <div class="UserAssets-right-text">
        <div>
          <select class="select1" v-model="selected" @click="op">
            <option v-for="item in typeList" v-bind:value="item.type">{{item.type}}</option>
          </select>
        </div>
        <div class="textBox">
          <img src="../assets/images/search.png" class="sear-img">
          <input type="text" placeholder="请输入账号、手机号、昵称进行查找" class="textWord" />
        </div>
        <div>
          ...
          <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="address" label="操作" width="200">
              <div class="operation">
                ...
                <div>
                  <el-button type="text" @click="dialogVisible = true"><img src="../assets/images/compile.png" /></el-button>
                </div>
                <div>
    ...
    <!-- 弹出框 -->
    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="tcClose">
      <span>添加用户</span>
...
<script>
  export default {
    ...
    methods: {
      ...
      //获取用户信息列表
      getUserMes() {
        this.$axios.get("http://49.64.169.6:8010/admin/api/users/?token=cb308adc8f920fb27b166f6f5f40c7d4&page=" + this.pagenum +
            "&row=14")
          .then(res => {
